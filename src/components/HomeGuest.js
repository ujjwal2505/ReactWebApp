    ...
    switch(action.type)
    {
      case "usernameImmediately":
        ...
        if(draft.username.value && !/^([a-zA-Z0-9]+)$/.test(draft.username.value)){
          draft.username.hasErrors=true;
          draft.username.message="Username must be alphanumeric"
        }     
        return
      ...
      case "usernameUniqueResult":
        ...
        {
          draft.username.hasErrors=true
          draft.username.message="Username aldredy exists"
      ...
      case "emailUniqueResult":
        ...
        {
          draft.email.hasErrors=true
          draft.email.message="Email aldredy exists"
      ...
      case "passwordImmediately":
        ...
        if(draft.password.value.length>50)
        {
          ...
          draft.password.message="Password can be maximum of 50 characters"
        }
        return
      case "passwordAfterDelay":
        ...
        {
          draft.password.hasErrors=true
          draft.password.message="Password should be greater than 12 characters"
        }
        return
      case "submitForm":
    ...
    if(state.username.checkCount)
    {
      ...
      async function fetchResult()
      {
        try {
          ...
          if(Axios.isCancel())
          {
            console.log("Axios cancel request");
          }
          else{
    ...
    if(state.submitCount)
    {
      ...
      async function fetchResult()
      {
        try {
          ...
          appDispatch({type:"flashMessage",value:"Successfully Signed In"})
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <CSSTransition in={state.username.hasErrors} classNames="liveValidateMessage" timeout={330} unmountOnExit >
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.email.hasErrors} classNames="liveValidateMessage" timeout={330} unmountOnExit >
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.password.hasErrors} classNames="liveValidateMessage" timeout={330} unmountOnExit >
